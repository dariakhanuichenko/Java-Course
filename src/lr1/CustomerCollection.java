...
public CustomerCollection(){
    ...
    public CustomerCollection(int n ) {
        ...
        this.customer[1] = new Customer("Aleksandr", "Zhuk", "Viktorovich", "Lvov, Postal Square", "9999888877776666", "1212121212");
        this.customer[2] = new Customer("Marina", "Tyshchenko", "Igorovna", "Lutsk Lenina street", "5555666644441111", "7125613458");
        this.customer[3] = new Customer("Roman", "Kolisnyi", "Aleksandrovich", "Odessa, Deribasovskaya street", "3333222211114444", "9854756215");
        this.customer[4] = new Customer("Benedict", "Cumberbatch", "Carlton", "London, city", "9999111199991111", "0000111100");
        this.customer[5] = new Customer("Martin", "Freeman", "Bob", "Amsterdam, st street", "1111999911119999", "1457265489");
    }
    ...
    public void addCustomer(Customer newCustomer) {
        if (this.numberOfCustomers < this.customer.length) {
           ...
           // System.out.print("New customer was added\n");
        } else System.out.print("Collection is full\n");
        //this.numberOfCustomers++;
    }
